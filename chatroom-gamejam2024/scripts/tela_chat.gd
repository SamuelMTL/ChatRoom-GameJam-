...
@export_file("res://Dialogue/json/textoChat1Intro.json") var json_file1: String = "" 
@export_file("res://Dialogue/json/textoChat1Op1.json") var json_file2: String = ""
@export_file("res://Dialogue/json/textoChat1Op2.json") var json_file3: String = ""
@export_file("res://Dialogue/json/textoChat1Fim.json") var json_file4: String = ""
